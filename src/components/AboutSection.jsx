    ...
    <section className="content-section content-section--about" id="about">
      ...
      >
        ...
        <p>
          ...
          производства декораций, создания брендинга. Мы работаем с частными лицами, бизнесом, ивент-агентствами и
          государственными структурами, в том числе через тендерные процедуры по 44-ФЗ и 223-ФЗ.
        </p>
      </motion.div>
